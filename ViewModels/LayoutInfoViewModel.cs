...
public class LayoutInfoViewModel : Screen
{
    ...
    private void SelectedRunOnRunChanged(RunModel? selectedRun)
    {
        ...
        NotifyOfPropertyChange(nameof(CanUpdateTwitch));
        NotifyOfPropertyChange(nameof(UpdateTwitch));
    ...
    public void ResetTwitchTitle()
    {
        Twitch.ResetTwitchTitle();
    }

    public void UpdateTwitchTitle()
    {
        if (_selectedRun == null)
        {
            return;
        ...
        Twitch.UpdateTwitchTitle(_selectedRun);
    }
    ...
    public void SendToScene()
    {
        ...
        _obs.SendRunToScene(selectedScene, new RunModel
        {
