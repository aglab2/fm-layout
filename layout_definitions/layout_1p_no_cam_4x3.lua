...
layout_1p_no_cam_4x3_source_def.get_properties = function(data)
    ...
    obs.obs_properties_add_int(ctx.props_def, util.setting_names.game_width, util.dashboard_names.game_width, 1, 1920, 1)
    obs.obs_properties_add_int(ctx.props_def, util.setting_names.game_height, util.dashboard_names.game_height, 1, 1080,
        1)
    obs.obs_properties_add_int(ctx.props_def, util.setting_names.game_x, util.dashboard_names.game_x, 0, 1920, 1)
    obs.obs_properties_add_int(ctx.props_def, util.setting_names.game_y, util.dashboard_names.game_y, 0, 1080, 1)
