...
layout_1p_w_cam_16x9_source_def.hide_commentators = function(ctx)
...
layout_1p_w_cam_16x9_source_def.get_name = function()
    return "FM 16x9 1 person with cam layout"
end

layout_1p_w_cam_16x9_source_def.create = function(settings, source)
    local data = {}
...
layout_1p_w_cam_16x9_source_def.get_defaults = function(settings)
...
local slider_modified = function(props, p, settings)
    local ctx = util.get_item_ctx(layout_1p_w_cam_16x9_source_def.id)
...
local update_run_info = function(props, p)
    ...
    layout_1p_w_cam_16x9_source_def.update(nil, ctx.props_settings)
...
layout_1p_w_cam_16x9_source_def.update = function(data, settings)
    local ctx = util.get_item_ctx(layout_1p_w_cam_16x9_source_def.id)
    ctx.props_settings = settings
...
layout_1p_w_cam_16x9_source_def.destroy = function(data)
...
layout_1p_w_cam_16x9_source_def.video_render = function(data, effect)
...
layout_1p_w_cam_16x9_source_def.get_width = function(data)
    return 1920
end

layout_1p_w_cam_16x9_source_def.get_height = function(data)
    return 1080
end

obs.obs_register_source(layout_1p_w_cam_16x9_source_def)
