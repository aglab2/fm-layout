...
layout_2p_tournament_source_def = {}
layout_2p_tournament_source_def.scene_name = "FM 2 person tournament layout"
layout_2p_tournament_source_def.id = "fm_2023_2_person_tournament"
layout_2p_tournament_source_def.output_flags = bit.bor(bit.bor(obs.OBS_SOURCE_VIDEO, obs.OBS_SOURCE_CUSTOM_DRAW),
    obs.OBS_SOURCE_CAP_DISABLED)

layout_2p_tournament_source_def.hide_commentators = function(ctx)
...
layout_2p_tournament_source_def.create = function(settings, source)
    local data = {}
    local ctx = util.create_item_ctx(layout_2p_tournament_source_def.id)
    ctx.scene = layout_2p_tournament_source_def.scene_name
...
layout_2p_tournament_source_def.get_defaults = function(settings)
...
local slider_modified = function(props, p, settings)
    local ctx = util.get_item_ctx(layout_2p_tournament_source_def.id)
...
local update_run_info = function(props, p)
    ...
    layout_2p_tournament_source_def.update(nil, ctx.props_settings)
...
layout_2p_tournament_source_def.get_properties = function(data)
    local ctx = util.get_item_ctx(layout_2p_tournament_source_def.id)
...
layout_2p_tournament_source_def.update = function(data, settings)
    local ctx = util.get_item_ctx(layout_2p_tournament_source_def.id)
    ctx.props_settings = settings
...
layout_2p_tournament_source_def.destroy = function(data)
...
layout_2p_tournament_source_def.video_render = function(data, effect)
...
layout_2p_tournament_source_def.get_width = function(data)
    return 1920
end

layout_2p_tournament_source_def.get_height = function(data)
    return 1080
end

obs.obs_register_source(layout_2p_tournament_source_def)
